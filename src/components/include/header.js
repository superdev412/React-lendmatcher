    ...
    <div>
      <div className="mobile-link-part" style={{ display: modalflag ? 'block' : 'none' }}>
        ...
        <div style={{marginTop:'50px'}}>
          ...
          <div className="mobile-link-con">
            <a href="#faq" className="link-btn" onClick={closemodal}>Login</a>
          </div>
          <div className="mobile-link-con">
            <a href="#roadmap" className="link-btn" onClick={closemodal}>Signup</a>
          </div>
        </div>
      </div>
        ...
        <div className="nav-bar row">
          ...
          <div className="col-lg-6 col-md-8 left-nav">
            <div className="link-part">
              ...
              <div className="link-con">
                <a href="#faq" className="link-btn">Login</a>
              </div>
              <div className="link-con">
                <a href="#roadmap"p className="link-btn">Signup</a>
              </div>
            </div>
            <div>
